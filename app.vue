...
useHead({
  ...
  meta: [
    ...
    { property: 'og:url', content: `https://addvision.dev${locale.value === 'uk' ? '' : '/' + locale.value}` },
...
<style lang="scss">
:root {
  /* 👇 Цей варіант особливо гарно працює для сучасних екранів (телефони → ноутбуки → 4K дисплеї). */

			...
			testimonials: {
				...
				list: [
					...
					},
					{
						...
						author: 'Марія К, артистка, піаністка, викладач, sandramaria.pro',
					},
					{
						...
						author: 'Кіра Б, засновниця Gouri.pl.com',
					},
					{
			...
			testimonials: {
				...
				list: [
					...
					},
					{
						...
						author: 'Vladyslav M, product owner at Unison',
					},
				],
			},
			faq: {

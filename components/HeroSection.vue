<template>
  <section
    ...
    class="hero-section box-shade"
    role="region"
  >
    <h1 style="display: none">
      <em>ADD</em> <strong>VISION</strong> — {{ $t("moto") }} | {{ $t("we-do.sences") }},
      {{ $t("we-do.texts") }}, {{ $t("we-do.visual") }}, {{ $t("we-do.dev") }}
    </h1>

    <HeaderSection />
    <VideoBackground base-path="/video/hero-section/" fit="contain" />
      ...
      <div class="brand">
        ...
        >
          ...
          <mask id="text-mask" maskUnits="userSpaceOnUse">
            <rect fill="white" height="2160" width="3840" />

            <g fill="black" filter="url(#svg-fade)" transform="translate(1275, 710)">
          ...
          <rect fill="#f1f6fc" height="2160" mask="url(#text-mask)" width="3840" />
        </svg>
      </div>

      <p class="moto glow-on-hover font-inter-semibold font-48">
        {{ $t("moto") }}
      </p>

      <aside class="we-do font-inter-semibold font-24">
        <ul>

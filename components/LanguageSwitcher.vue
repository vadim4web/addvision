...
<template>
  <ul class="language-switcher font-inter-regular font-24">
...
.language-link {
  ...
  &::after {
    ...
    transition: background var(--transition-default) ease,
      filter var(--transition-filter) ease;
    z-index: -1;
    filter: drop-shadow(0 0 0 var(--accent75)) contrast(1) brightness(1) hue-rotate(0deg);

<template>
  <nav
    ...
    class="nav font-inter-regular font-24"
  >
    <!-- Navigation list -->
    <ul ref="menuRef" class="nav-list" :class="{ open: isOpen }">
      ...
      <li>
        <a :data-text="$t('navigation.why-us')" href="#why-us" @click="closeMenu">
          {{ $t("navigation.why-us") }}
        </a>
      </li>
      <li>
        <a :data-text="$t('navigation.services')" href="#services" @click="closeMenu">
          {{ $t("navigation.services") }}
        </a>
      </li>
      <li>
        <a :data-text="$t('navigation.contacts')" href="#contacts" @click="closeMenu">
        ...
        >
          ...
          >
            <g transform="translate(0, 20)">
              <defs>
                <filter id="white-glow" height="200%" width="200%" x="-50%" y="-50%">
                  <feDropShadow
                    dx="0"
                    dy="0"
  ...
  li a {
    ...
    &::after {
      ...
      transition: height var(--transition-default) ease,
        filter var(--transition-filter) ease;
      z-index: -1;
    ...
    &:hover::after {
      height: 1.25em;
      filter: drop-shadow(0 0 0.15rem var(--accent75)) contrast(1.15) brightness(1.15)
        hue-rotate(360deg);

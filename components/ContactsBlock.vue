<template>
  <div class="contacts-block font-inter-regular">
    <pre class="call-to-action glow-on-hover text-shade font-26"
      >{{ $t("contacts.CTA") }}
    </pre>
    <address class="contacts-block-links font-28">
      <!-- icon source:
      https://www.svgrepo.com/
      https://www.iconpacks.net/
      -->

      <a class="glow-on-hover" href="tel:+380933789883">
        <svg
          height="256"
          version="1.1"
          viewBox="0 0 256 256"
      ...
      <a class="glow-on-hover" href="https://wa.me/380933789883">
        <svg
          height="256"
          version="1.1"
          viewBox="0 0 256 256"
      ...
      <a class="glow-on-hover" href="http://t.me/vadim4web">
        <svg
          fill="var(--text-main)"
          height="800px"
          viewBox="0 0 24 24"
